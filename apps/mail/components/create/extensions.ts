...
// Build and return a fresh set of configured extensions for each editor instance.
// Returning new instances avoids ProseMirror plugin key collisions when multiple
// editors mount in the same React render (Concurrent/Strict mode).
import { Extension } from '@tiptap/core';

export function defaultExtensions() {
  // TODO: cx usage is only for Tailwind autocomplete
